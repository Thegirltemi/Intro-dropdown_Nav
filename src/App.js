...
import desktop from "./Components/images/image-hero-desktop.png";
import mobile from "./Components/images/image-hero-mobile.png";
...
import chevronDown from "./Components/images/icon-arrow-down.svg";
import chevronUp from "./Components/images/icon-arrow-up.svg";
import menuOpen from "./Components/images/icon-menu.svg";
import closeMenu from "./Components/images/icon-close-menu.svg";
import todolist from "./Components/images/icon-todo.svg";
import reminders from "./Components/images/icon-reminders.svg";
import calendar from "./Components/images/icon-calendar.svg";
import planning from "./Components/images/icon-planning.svg";
...
function App() {
  ...
  return (
    <>
        ...
        <div className="lg:flex lg:items-start lg:justify-start">
          ...
          <nav className="navbar">
            <div>
              ...
              >
                Features
                {openFeatures ? <img src={chevronUp} alt="" className="ml-2" />:<img src={chevronDown} alt="" className="ml-2" />}
              </button>
              {openFeatures && (
            ...
            <div>
              ...
              >
                Company
                {openCompany ? <img src={chevronUp} alt="" className="ml-2" />:<img src={chevronDown} alt="" className="ml-2" />}
      ...
      <section
        className=" flex flex-col-reverse py-20  md:grid  md:gap-10 md:grid-cols-2 md:place-items-center
